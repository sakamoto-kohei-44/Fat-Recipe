(() => {
  ...
  var autocomplete_controller_default = class extends Controller {
    ...
    updateSuggestions(event) {
      ...
      if (query.length > 2) {
        fetch(`/recipes/autocomplete?query=${encodeURIComponent(query)}`).then((response) => response.json()).then((data) => this.showSuggestions(data)).catch((error) => console.error(error));
      } else {
...
//# sourceMappingURL=assets/controllers/autocomplete_controller.js.map
